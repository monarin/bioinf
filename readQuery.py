...
#Define exceptions
class ReadQueryError(Exception): pass
class InvalidColumnCount(ReadQueryError): pass
class InvalidTR(ReadQueryError): pass
class InvalidInputFile(ReadQueryError): pass
