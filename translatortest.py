...
class KnownValues(unittest.TestCase):
	CIGARObj = {'TR1': {'CHR1': (3, '8M7D6M2I2M11D7M')},
			'TR2': {'CHR2': (10, '20M')}}
	knownTranslateTbl_TR2CHR = {'TR1': {'CHR1': [(0, 3), (8, 11), (8, 18), (14, 24), (16, 24), (18, 26), (18, 37), (25, 44)]}, \
			'TR2': {'CHR2': [(0, 10), (20, 30)]}}
	knownTranslateTbl_CHR2TR = {'CHR1': {'TR1': [(3, 0), (11, 8), (18, 8), (24, 14), (24, 16), (26, 18), (37, 18), (44, 25)]}, \
			'CHR2': {'TR2': [(10, 0), (30, 20)]}}
	knownValuesToCHR = (('TR1', 4, 'CHR1', 7),
			('TR1', 14, 'CHR1', 'I24'), 
			('TR1', 0, 'CHR1', 3),
			('TR1', 24, 'CHR1', 43),
			('TR2', 0, 'CHR2', 10),
