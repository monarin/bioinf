...
#Define exceptions
class ReadCIGARError(Exception): pass
class InvalidColumnCount(ReadCIGARError): pass
class InvalidStartingPosition(ReadCIGARError): pass
class InvalidInputFile(ReadCIGARError): pass
